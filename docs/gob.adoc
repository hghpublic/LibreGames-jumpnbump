= The Format of GOB Files
:toc:
:sectnums:


Do _YOU_ want to make your own `GOB`-files?
...
[NOTE]
====
Everything is saved in Intel byteorder,
ie the least significant byte first (Little-Endian).
====
